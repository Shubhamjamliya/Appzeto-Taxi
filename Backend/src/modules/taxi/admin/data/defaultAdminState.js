...
export const createDefaultAdminState = () => {
  ...
  return {
    ...
    serviceLocations: [
      { _id: indoreId, name: 'Indore', service_location_name: 'Indore', country: 'India', currency: 'INR', active: true },
      { _id: delhiId, name: 'New Delhi', service_location_name: 'New Delhi', country: 'India', currency: 'INR', active: true },
    ],
    rideModules: [
    ...
    zones: [
      {
        _id: objectId(),
        service_location_id: indoreId,
        name: 'Vijay Nagar Prime',
        unit: 'km',
        peak_zone_ride_count: 15,
        peak_zone_radius: 3,
        peak_zone_selection_duration: 10,
        peak_zone_duration: 25,
        peak_zone_surge_percentage: 18,
        maximum_distance_for_regular_rides: 25,
        maximum_distance_for_outstation_rides: 120,
        active: true,
        coordinates: [
          { lat: 22.7533, lng: 75.8937 },
          { lat: 22.758, lng: 75.899 },
          { lat: 22.748, lng: 75.905 },
        ],
      },
      {
        _id: objectId(),
        ...
        unit: 'km',
        peak_zone_ride_count: 20,
        peak_zone_radius: 4,
        peak_zone_selection_duration: 12,
        peak_zone_duration: 30,
        peak_zone_surge_percentage: 22,
        maximum_distance_for_regular_rides: 30,
        maximum_distance_for_outstation_rides: 200,
        active: false,
        coordinates: [
          { lat: 28.6315, lng: 77.2167 },
          { lat: 28.635, lng: 77.221 },
          { lat: 28.628, lng: 77.226 },
        ],
      },
    ],
    subscriptionPlans: [
