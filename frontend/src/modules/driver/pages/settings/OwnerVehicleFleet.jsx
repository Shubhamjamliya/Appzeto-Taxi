            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  <h1 className="text-lg sm:text-2xl font-black text-slate-900 tracking-tight">My Vehicles</h1>
                  <div className="px-2 py-0.5 rounded-full bg-indigo-50 border border-indigo-200 flex-shrink-0">
                    <span className="text-[10px] sm:text-xs font-bold text-indigo-600 uppercase tracking-wider">{vehicles.length}</span>
                  </div>
                </div>
                <p className="text-xs sm:text-sm text-slate-500 font-medium leading-tight">Manage your fleet</p>
              </div>
            </div>
            <motion.button
              whileHover={{ scale: 1.05 }}
              ...
              <motion.div
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {vehicle.isFleetVehicle && vehicle.status === "approved" && (
                      <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold flex-shrink-0">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-600" />
                        Approved
                      </div>
                    )}
                    {vehicle.isFleetVehicle && vehicle.status === "rejected" && (
                  ...
                  <div className="text-xs sm:text-sm text-gray-600 space-y-0.5">
                    <p>Plate: <span className="font-medium">{vehicle.vehicleNumber}</span></p>
                    <p>Color: <span className="font-medium capitalize">{vehicle.vehicleColor}</span></p>
                  </div>
                </div>
